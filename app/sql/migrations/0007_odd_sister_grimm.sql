...
ALTER TABLE "messages" ADD CONSTRAINT "messages_sender_profiles_profile_id_fk" FOREIGN KEY ("sender") REFERENCES "public"."profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
